...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "wandersonsantiago86@gmail.com", "36378912377", TipoCliente.PESSOA_FISICA, pe.encode("123456"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		cli1.addPerfil(Perfil.ADMIN);
		
		Cliente cli2 = new Cliente(null, "Wanderson", "wandersonsantiago@gmail.com", "275.343.452-27", TipoCliente.PESSOA_FISICA, pe.encode("123456"));
		cli2.getTelefones().addAll(Arrays.asList("273677723", "93777393"));
